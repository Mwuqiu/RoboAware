...
DATASET_ROOT = "/root/autodl-tmp/cosmos_training_data_world_arena_ablation_10tasks"
...
EXPERIMENT_NAME = "predict2_point_adapter_v5_controlnet_10tasks"
...
experiment_config = dict(
    ...
    job=dict(
        ...
        group="point_adapter",
        name="v5_controlnet_10tasks_480x640",
    ),
