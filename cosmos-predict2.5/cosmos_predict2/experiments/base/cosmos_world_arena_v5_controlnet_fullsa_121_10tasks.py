...
#
# V5 ControlNet experiment: full adapter Block + ControlNet-style weight copy
...
#   - num_frames=121
#   - point_adapter_adapter_mode="full" so adapter Block runs self-attn,
#     cross-attn, and MLP instead of bypassing self-attn
...
model_conf = dict(
    config=dict(
        ...
        net=dict(
            ...
            point_adapter_adapter_mode="full",                  # self-attn + cross-attn + MLP
...
EXPERIMENT_NAME = "predict2_point_adapter_v5_controlnet_fullsa_121_10tasks_worldarena"
...
experiment_config = dict(
    ...
    job=dict(
        ...
        group="point_adapter",
        name="v5_controlnet_fullsa_121_10tasks_worldarena_480x640",
    ),
